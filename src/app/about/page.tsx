        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <div className="rounded-2xl overflow-hidden border border-border"><img src="/images/ceo-imran-ali.png" alt="Mr. Imran Ali — Founder & CEO Golden Willowe Sports" className="w-full h-[500px] object-cover object-center" /></div>
            </motion.div>
          </div>
        </div>
      </section>
